...
$I->login();
$I->amOnPage ('/document');
$I->waitForText ('Документы','5','//h2');


//Поиск по id
$I->applyPageFilter ('//*[@id="documents-table-filters"]/td[1]/input','1234');
$I->waitForText ('COSMRUMAXXXX',10);
$I->see ('Терминал для тестирования входящих сообщений','//*[@id="documents-table"]/table/tbody/tr/td[6]');
$I->seeNumberOfElements ('//*[@id="documents-table"]//tbody/tr','1');
$I->clearPageFilter ('//*[@id="documents-table-filters"]/td[1]/input');
